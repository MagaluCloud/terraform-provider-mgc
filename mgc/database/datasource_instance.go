...
func (r *DataSourceDbInstance) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	data.BackupRetentionDays = types.Int64PointerValue(utils.ConvertIntPointerToInt64Pointer(&instance.BackupRetentionDays))
	...
	data.VolumeSize = types.Int64PointerValue(utils.ConvertIntPointerToInt64Pointer(&instance.Volume.Size))
