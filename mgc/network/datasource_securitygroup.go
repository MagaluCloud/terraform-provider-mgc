...
type NetworkSecurityGroupModel struct {
	...
	Rules       []NetworkSecurityGroupRuleDataSourceModel `tfsdk:"rules"`
...
type NetworkSecurityGroupRuleDataSourceModel struct {
	CreatedAt       types.String `tfsdk:"created_at"`
...
func (r *NetworkSecurityGroupDataSource) Schema(_ context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *NetworkSecurityGroupDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_network_security_group"
}

func (r *NetworkSecurityGroupDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *NetworkSecurityGroupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
...
func securityGroupRulesSdkModelToTerraform(rules *[]netSDK.RuleResponse) []NetworkSecurityGroupRuleDataSourceModel {
	if rules == nil {
		return []NetworkSecurityGroupRuleDataSourceModel{}
	}

	var terraformRules []NetworkSecurityGroupRuleDataSourceModel
	for _, rule := range *rules {
		terraformRules = append(terraformRules, NetworkSecurityGroupRuleDataSourceModel{
			...
			PortRangeMax:    types.Int64PointerValue(utils.ConvertIntPointerToInt64Pointer(rule.PortRangeMax)),
			PortRangeMin:    types.Int64PointerValue(utils.ConvertIntPointerToInt64Pointer(rule.PortRangeMin)),
